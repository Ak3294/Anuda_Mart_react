      ...
      <div className="p-1">
        ...
        <div className="flex flex-col gap-3 sm:flex-row w-full mb-4">
            ...
            <div className="mt-6 items-center justify-between mb-2">
              ...
              <div className="max-w-sm  bg-white rounded-lg p-1">
                <div className="flex items-center mb-4">
                  ...
                  <span className="ml-6 w-full border p-2">@richard_marshall</span>
                </div>
                <div className="flex items-center mb-4">
                  <button className="flex items-center bg-gray-200 hover:bg-gray-300 text-red-500 font-bold py-1 px-2 rounded">
                    <svg
                  ...
                  <span className="ml-6 w-full border p-2"> +91 1245126510 </span>
                </div>
                ...
                <div className="flex items-center mb-4">
                  ...
                  <span className="ml-6 w-full border p-2" > www.streex.com</span>
                </div>
                <div className="flex items-center mb-4">
                  <button className="flex items-center bg-gray-200 hover:bg-gray-300 text-red-500 font-bold py-1 px-2 rounded">
                    <svg
                  ...
                  <span className="ml-6 w-full border p-2" >Richard Marshall</span>
                </div>
                <div className="flex items-center mb-4">
                  <button className="flex items-center bg-gray-200 hover:bg-gray-300 text-red-500 font-bold py-1 px-2 rounded">
                    <svg
                  ...
                  <span className="ml-6 w-full border p-2">@richardmarshall</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="w-full sm:w-3/4 p-2 ">
            <div className="flex items-center justify-center  h-[20%] mx-3">
