      ...
      <div className="p-1">
        ...
        <div className="flex flex-col gap-3 sm:flex-row w-full mb-4">
          <div className="bg-white rounded-lg shadow-md w-full sm:w-1/4 p-2 ">
            ...
            <div className="text-center mt-2 mb-2 flex justify-center items-center space-x-1">
            ...
            <div className="flex items-center space-x-1 align-center justify-center mb-6 ">
